...
if args.provider == 'ollama':
    results_file = f"evaluation/join/Q9/results/lotus_Q9_join_default_{args.model.replace(':', '_')}_{args.provider}_{args.size}.csv"
elif args.provider == 'vllm':
    results_file = f"evaluation/join/Q9/results/lotus_Q9_join_default_{args.model.replace('/', ':')}_{args.provider}_{args.size}.csv"
