...
if args.provider == 'ollama':
    results_file = f"evaluation/derivation/Q2/results/lotus_Q2_map_{args.model.replace(':', '_')}_{args.provider}_{args.size}.csv"
...
# # -------- Extract --------
# if args.provider == 'ollama':
#     results_file = f"evaluation/derivation/Q2/results/lotus_Q2_extract_{args.model.replace(':', '_')}_{args.provider}_{args.size}.csv"
# elif args.provider == 'vllm':
#     results_file = f"evaluation/derivation/Q2/results/lotus_Q2_extract_{args.model.replace('/', '_')}_{args.provider}_{args.size}.csv"
