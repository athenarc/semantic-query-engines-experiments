...
if args.wandb:
    run_name = f"lotus_Q7_filter_default_{args.model.replace(':', '_')}_{args.provider}_{args.size}"
...
if args.wandb:
    if args.provider == 'ollama':
        output_file = f"evaluation/selection/Q7/results/lotus_Q7_filter_default_{args.model.replace(':', '_')}_{args.provider}_{args.size}.csv"
    elif args.provider =='vllm':
        output_file = f"evaluation/selection/Q7/results/lotus_Q7_filter_default_{args.model.replace('/', '_')}_{args.provider}_{args.size}.csv"
