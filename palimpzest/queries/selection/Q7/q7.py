...
if args.wandb:
    run_name=f"palimpzest_Q7_filter_{args.model.replace(':', '_')}_{args.provider}_{args.size}"
...
if args.wandb:
    if args.provider == 'ollama':
        output_file = f"evaluation/selection/Q7/results/palimpzest_Q7_filter_{args.model.replace(':', '_')}_{args.provider}_{args.size}.csv"
