...
if args.wandb:
    run_name = f"blendsql_Q4_map_{args.model.replace(':', '_')}_{args.provider}_{args.size}"
...
if args.wandb:
    smoothie.df.to_csv(f"evaluation/derivation/Q4/results/blendsql_Q4_map_{args.model.replace('/', '_').replace(':', '_')}_{args.provider}_{args.size}.csv")
