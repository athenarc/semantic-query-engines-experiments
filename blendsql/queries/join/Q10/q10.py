...
if args.wandb:
    run_name = f"blendsql_Q10_join_{args.model.replace(':', '_')}_{args.provider}_{args.size}"
...
if args.wandb:
    smoothie.df.to_csv(f"evaluation/join/Q10/results/blendsql_Q10_join_{args.model.replace('/', ':')}_{args.provider}_{args.size}.csv")
